...
Step 1: Examine if there are any ‘rDNA-like’ regions across the mouse reference genome (GRCm38.p6) that can interfere with read alignment

1.1 First the rDNA canonical copy was fragmented in-silico to generate overlapping fragments with step size of 1bp

(using https://www.genecorner.ugent.be/split_fasta.html)

Fragments of different sizes were used for the analysis (50bp, 100bp, 250bp, 500bp and 1000bp)
...
<img width="500" alt="Screen Shot 2022-01-13 at 7 32 03 pm" src="https://user-images.githubusercontent.com/36429476/149294286-2cd18221-385c-4f05-813f-7b55d9d0d9c1.png">

<img width="500" alt="Screen Shot 2022-01-13 at 7 32 24 pm" src="https://user-images.githubusercontent.com/36429476/149294299-ec554279-bf66-4d3f-a9f0-a35fa42cef0f.png">
...
2.3 ‘rDNA-like’ sequences across the genome were extracted as a .bed file (using R packages) and the identified regions were masked using maskfasta - bedtools. 
...
<img width="500" alt="Screen Shot 2022-01-13 at 7 42 51 pm" src="https://user-images.githubusercontent.com/36429476/149296160-7047b059-2108-4b53-a155-d2ab7cc75a03.png">
